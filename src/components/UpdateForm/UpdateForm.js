...
const UpdateForm = ({
  ...
  const { handleSubmit, handleDeleteEvent, handleChange } = useUpdateFormHook();
  ...
  return (
    ...
    >
      <Title>Update idea item</Title>

      <SubTitle>Created at: {createdAt}</SubTitle>

      {updatedAt && <SubTitle>Updated at: {updatedAt}</SubTitle>}
      ...
      <StyledField
        ...
        value={newTitle}
        onChange={e =>
          handleChange(e, setNewTitle, setNewDesc, setNewDate, setNewTime)
        }
      />
      <StyledField
        type="text"
